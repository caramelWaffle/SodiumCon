...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setToolbarTitle(int position){
      ...
      //  Toast.makeText(getContext(),"POSITON : "+ position,Toast.LENGTH_SHORT).show();
        ...
        if(positionx == 0) {
            myActivity.setTitle(getContext().getString(R.string.Overview));
        }else
        if (position == 1){
            myActivity.setTitle(getContext().getString(R.string.food));
        }else
         if (position == 2){
             myActivity.setTitle(getContext().getString(R.string.fact));
         }
        else {
             myActivity.setTitle(getContext().getString(R.string.Leaderboard));
         }
    }
